...
def train_and_evaluate_model(df, features, target):
    '''
    Return the accuracy and mean square error of popularity of songs, predicting through song features.
    Plot and calculate the correlation between Predicted Popularity and Actual Popularity
    '''
    ...
    print(f"Correlation between Predicted Popularity and Actual Popularity: {correlation:.2f}")
